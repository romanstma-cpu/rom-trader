...
function sanitize(s: Settings): Settings {
  ...
  return {
    ...
    momentumThresholdCents: num(s.momentumThresholdCents, 1, 50, DEFAULT_SETTINGS.momentumThresholdCents),
    takeProfitCents: num(s.takeProfitCents, 1, 90, DEFAULT_SETTINGS.takeProfitCents),
    stopLossCents: num(s.stopLossCents, 1, 90, DEFAULT_SETTINGS.stopLossCents),
    tickSeconds: num(s.tickSeconds, 5, 600, DEFAULT_SETTINGS.tickSeconds),
    maxSpreadCents: num(s.maxSpreadCents, 1, 20, DEFAULT_SETTINGS.maxSpreadCents),
    minPriceCents: num(s.minPriceCents, 1, 98, DEFAULT_SETTINGS.minPriceCents),
    maxPriceCents: num(s.maxPriceCents, 2, 99, DEFAULT_SETTINGS.maxPriceCents),
    dailyLossLimitUsd: num(s.dailyLossLimitUsd, 0, 1_000_000, DEFAULT_SETTINGS.dailyLossLimitUsd),
    reentryCooldownSeconds: num(s.reentryCooldownSeconds, 0, 3600, DEFAULT_SETTINGS.reentryCooldownSeconds),
    maxConsecutiveLosses: Math.round(num(s.maxConsecutiveLosses, 0, 100, DEFAULT_SETTINGS.maxConsecutiveLosses)),
    trailingStopCents: Math.round(num(s.trailingStopCents, 0, 90, DEFAULT_SETTINGS.trailingStopCents)),
    tradingHoursEnabled: Boolean(s.tradingHoursEnabled),
    tradingStartHour: Math.round(num(s.tradingStartHour, 0, 23, DEFAULT_SETTINGS.tradingStartHour)),
    tradingEndHour: Math.round(num(s.tradingEndHour, 0, 23, DEFAULT_SETTINGS.tradingEndHour)),
